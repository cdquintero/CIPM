...
dx=0.1; Lenght=1.0; n=int(Lenght/dx+2) #N̼mero de nodos
x=np.zeros(n)
...
#______________________11______________________________________________
...
def Thomas(T,aP,aW,aE,Su,n,Cp,A,TB,tolerance):
    ...
    max_iter=100000; residual=1; iter_GS=0; m=0; r_0=0
...
def SOR(aW,aP,aE,Su,n,T,tolerance):
    ...
    T0=np.zeros(n)
    max_iter=100000000; residual=1; iter_GS=0; m=0; r_0=0
    param=1.01
    acum= np.zeros(n-2)
